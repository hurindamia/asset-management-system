...
LEFT JOIN (
    ...
    FROM ram
    GROUP BY asset_id
) ram_agg ON assets.asset_id = ram_agg.asset_id
...
<h1 class="page-title">
<?php echo htmlspecialchars($data['name']); ?> — <?php echo htmlspecialchars($asset_type); ?> (Asset ID: <?php echo htmlspecialchars($data['ID']); ?>)
</h1>
...
<div><b>Name</b><p><?php echo htmlspecialchars($data['name']); ?></p></div>
<div><b>Email</b><p><?php echo htmlspecialchars($data['email_id']); ?></p></div>

<div><b>Position</b><p><?php echo htmlspecialchars($data['position']); ?></p></div>
<div><b>Email Password</b><p><?php echo htmlspecialchars($data['email_password']); ?></p></div>

<div><b>Contact No</b><p><?php echo htmlspecialchars($data['contact_no']); ?></p></div>
<div><b>Mail Server</b><p><?php echo htmlspecialchars($data['mail_server']); ?></p></div>

<div><b>Asset ID</b><p><?php echo htmlspecialchars($data['ID']); ?></p></div>
<div><b>Device Type</b><p><?php echo htmlspecialchars($asset_type); ?></p></div>
...
<p><b>PC Username:</b> <?php echo htmlspecialchars($data['pc_username']); ?></p>
<p><b>PC Password:</b> <?php echo htmlspecialchars($data['pc_password']); ?></p>
</div>
</div>
...
<p><b>CPU Model:</b> <?php echo htmlspecialchars($data['cpu_model']); ?></p>
<p><b>CPU Speed:</b> <?php echo htmlspecialchars($data['cpu_speed']); ?></p>
<p><b>Cores:</b> <?php echo htmlspecialchars($data['cpu_core']); ?></p>
<p><b>Hyper Threading:</b> <?php echo htmlspecialchars($data['cpu_hyper_thread']); ?></p>
<p><b>GPU:</b> <?php echo htmlspecialchars($data['graphic_card']); ?></p>
</div>
</div>
...
<p><?php echo htmlspecialchars($ramText." = ".$total." GB"); ?></p>
<p>(<?php echo htmlspecialchars($slots); ?> slots)</p>
</div>
</div>
...
<div class="card-body-windows"><?php echo htmlspecialchars($data['windows_key']); ?></div>
</div>
...
<div class="card-body-pc">
<p><b>Model:</b> <?php echo htmlspecialchars($data['pc_model']); ?></p>
<p><b>Serial Number:</b> <?php echo htmlspecialchars($data['serial_no']); ?></p>
<p><b>Storage Capacity:</b> <?php echo htmlspecialchars($data['storage_capacity']); ?></p>
<p><b>iOS Version:</b> <?php echo htmlspecialchars($data['os_version']); ?></p>
<p><b>IMEI / UDID:</b> <?php echo htmlspecialchars($data['imei']); ?></p>
</div>
</div>
...
<div class="card-body-cpu">
<p><b>MAC WiFi:</b> <?php echo htmlspecialchars($data['mac_wifi']); ?></p>
<p><b>SIM Number:</b> <?php echo htmlspecialchars($data['sim_no']); ?></p>
</div>
</div>
...
<p><b>Apple ID:</b> <?php echo htmlspecialchars($data['apple_id']); ?></p>
<p><b>Apple ID Password:</b> <?php echo htmlspecialchars($data['apple_password']); ?></p>
</div>
</div>
...
<p><b>Model:</b> <?php echo htmlspecialchars($data['pc_model']); ?></p>
<p><b>Serial Number:</b> <?php echo htmlspecialchars($data['serial_no']); ?></p>
<p><b>IMEI:</b> <?php echo htmlspecialchars($data['imei']); ?></p>
<p><b>OS Version:</b> <?php echo htmlspecialchars($data['os_version']); ?></p>
<p><b>Storage Capacity:</b> <?php echo htmlspecialchars($data['storage_capacity']); ?></p>
</div>
</div>
...
<div class="card-body-cpu">
<p><b>SIM Number:</b> <?php echo htmlspecialchars($data['sim_no']); ?></p>
<p><b>Carrier / Provider:</b> <?php echo htmlspecialchars($data['carrier']); ?></p>
<p><b>MAC WiFi:</b> <?php echo htmlspecialchars($data['mac_wifi']); ?></p>
</div>
</div>
...
<div class="card-body-windows">
<p><b>Email:</b> <?php echo htmlspecialchars($data['account_email']); ?></p>
<p><b>Password:</b> <?php echo htmlspecialchars($data['account_password']); ?></p>
</div>
</div>
...
<a href="edit_asset.php?id=<?php echo htmlspecialchars($data['ID']); ?>" class="edit-btn big-btn">Edit</a>
<a href="delete_asset.php?id=<?php echo htmlspecialchars($data['ID']); ?>" class="delete-btn big-btn" onclick="return confirm('Delete this asset?')">Delete</a>
</div>
